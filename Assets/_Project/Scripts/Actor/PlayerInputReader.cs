...
public class PlayerInputReader : MonoBehaviour
{
    ...
    [Tooltip("숫자 3번 키 비료")]
    [SerializeField] private InputActionReference tool3Action;
    ...
    public event Action OnTool3Event;
    ...
    private void OnEnable()
    {
        ...
        if (tool3Action != null)
        {
            ...
            tool3Action.action.performed += OnTool3Performed;
        }
    }
    ...
    private void OnTool3Performed(InputAction.CallbackContext context) => OnTool3Event?.Invoke();
}
